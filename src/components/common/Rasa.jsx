    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 container mx-auto w-full">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className=" rounded rounded-[24px] row-span-2 lg:h-[100%] xl:h-[100%] md:h-[100%] h-[60%] bg-center bg-[#0A2D19] flex justify-center items-center lg:order-none order-last"
        >
           <WobbleCard
