  ...
  return (
    <div className="relative">
      ...
      <div className="container mx-auto lg:px-40 xl:px-40 md:px-10 px-4 my-20 relative z-10">
        {/* Heading Section */}
        <div>
          <h1 className="text-black text-[30px] lg:text-[40px] xl:text-[40px] md:text-[40px]  text-center font-bold">
            SELAMAT DATANG DI PHILIA ADVENTURE PARK!
          </h1>
        </div>

        {/* Description Section */}
        <div className=" mt-6 text-center xl:text-justify md:text-justify lg:text-justify">
